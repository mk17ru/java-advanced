...
public class RemotePerson extends CommonPerson<RemoteAccount> {
    ...
    public RemotePerson(RemoteBank bank, final String passportInfo, final String firstName, final String lastName) throws RemoteException {
...
//    @Override
//    public Account getPersonAccount(String sudId) {
//        String accountId = CommonMethods.createAccountId(getPassportInfo(), sudId);
//        return bank.getPersonAccount(accountId);
//    }
//
//    @Override
//    public Map<String, Account> getPersonAccounts() {
//        return bank.getPersonAccounts(getPassportInfo());
//    }
