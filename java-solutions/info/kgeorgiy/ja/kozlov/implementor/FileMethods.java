...
public class FileMethods {
    ...
    public static Path createPath(final String ending, final Path inputPath, final Class<?> currentToken) {
        final Path currentPath = inputPath
                .resolve(currentToken.getPackageName().replace(".", File.separator))
                .resolve(String.join("", getClassName(currentToken), ending));
        // :NOTE: no need for an absolute path
